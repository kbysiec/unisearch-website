...
export function PhoneMock({ className, priority = false }: PhoneMockProps) {
  return (
    ...
    >
      ...
      <div className="relative rounded-[40px] border border-white/60 bg-white/70 p-3 shadow-2xl shadow-primary-500/20 backdrop-blur">
        <div className="relative aspect-[9/19.5] w-full overflow-hidden rounded-[32px] border border-white/50 bg-gray-900">
          <Image
